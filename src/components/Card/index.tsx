...
export const Card = ({ index, textButton, data }: CardProps) => {
  ...
  return (
    ...
    >
      <div className="rounded-lg overflow-hidden">
        <img className="w-full h-55 " src={data?.image} alt="Pet Perdido" />
      </div>
      <div className="p-4">
        ...
        <p className="text-white mt-2 font-medium">📍 Cidade: Teste</p>
        <div className="mt-4">
