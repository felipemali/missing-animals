export const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center bg-[#333333] text-base-content rounded p-10">
      ...
      <aside>
        <p>
          Copyright © {new Date().getFullYear()} - Todos direitos reservados por
          Felipe Lima
        </p>
      </aside>
    </footer>
